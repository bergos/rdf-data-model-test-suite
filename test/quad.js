...
function runTests (DataFactory) {
  describe('.quad', function () {
    ...
    describe('.equals', function () {
      ...
      it('should return false if the subject of the other quads is not the same', function () {
      ...
      it('should return false if the predicate of the other quads is not the same', function () {
        var subject = DataFactory.namedNode('http://example.org/subject')
      ...
      it('should return false if the object of the other quads is not the same', function () {
        var subject = DataFactory.namedNode('http://example.org/subject')
        var predicate = DataFactory.namedNode('http://example.org/predicate')
      ...
      it('should return false if the graph of the other quads is not the same', function () {
        var subject = DataFactory.namedNode('http://example.org/subject')
        var predicate = DataFactory.namedNode('http://example.org/predicate')
        var object = DataFactory.namedNode('http://example.org/object')
    ...
    describe('.toCanonical', function () {
      it('should return a canonical representation', function () {
        var subject = DataFactory.namedNode('http://example.org/subject')
        var predicate = DataFactory.namedNode('http://example.org/predicate')
        var object = DataFactory.namedNode('http://example.org/object')
        var graph = DataFactory.namedNode('http://example.org/graph')
